...
const pairs = [
  ...
  ['texto', TEXT, 'claro: destructive/card',        '#e10600', '#ffffff'],
  ['texto', TEXT, 'claro: warning/card',            '#b5600a', '#ffffff'],
  ['texto', TEXT, 'claro: success/card',            '#1f7a4d', '#ffffff'],
  ...
  ['texto', TEXT, 'escuro: destructive/card',       '#ff5449', '#2a2a2a'],
